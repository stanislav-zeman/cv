...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Stanislav}}}}} % First name
	
	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Zeman}}}}} % Last name
	
	\vspace{6pt}
	
	{\huge Backend Developer} % Career or current job title
\end{minipage}
